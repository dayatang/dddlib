	  ...
	  <form id="form">
	  	<table class="form2column">
	  		...
	  		<tr>
	  			...
	  			<td class="content"><input type="text" id="resUrl" name="identifier" class="input-common"  validate="{required:true}" /></td>
	  		</tr>
	  		<tr>
	  		...
	  		<tr>
	  			...
	  			<td class="content"><input type="text" id="type" name="type" class="input-common" validate="{required:true}" /></td>
	  		</tr>
	  	</table>
	  </form>
  </div>
