(function ($)
{
    ...
    {
        rootPath = rootPath || "";
        LG.prevLoadImage(rootPath + 'js/ligerUI/skins/Aqua/images/win/', ['dialog-icons.gif']);
        LG.prevLoadImage(rootPath + 'js/ligerUI/skins/Gray/images/win/', ['dialogicon.gif']);
    };
    ...
    {
        var p = options || {};
        var url = p.module+"-"+p.type+"-"+p.method+".action";
        $.ajax({
            cache: false,
            async: true,
            url: url,
