...
public class KoalaWSHumanTaskHandler implements WorkItemHandler {
	 private String ipAddress = "127.0.0.1";
	    ...
	    private static final Logger logger = LoggerFactory.getLogger(KoalaWSHumanTaskHandler.class);
		private boolean initialized = false;
	    
	    public KoalaWSHumanTaskHandler() {
	    }

	    public KoalaWSHumanTaskHandler(TaskService client) {
	        this.client = client;
	    }
	    
	    public KoalaWSHumanTaskHandler(TaskService client, KnowledgeRuntime session) {
	        this.client = client;
	    ...
	    public void executeWorkItem(WorkItem workItem, WorkItemManager manager) {
	        ...
	        if (actorId != null && actorId.trim().length() > 0) {
	            ...
	            if (potentialOwners.size() > 0) {
	                ...
	                taskData.setActualOwner((User) new User("&&KOALA_ASSIGN"));
	            }
	        }
