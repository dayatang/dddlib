...
public class JBPMApplicationImplService extends Service {
	...
	private final static Logger logger = Logger
			.getLogger(org.openkoala.koala.jbpm.wsclient.JBPMApplicationImplService.class
					.getName());
	...
	static {
		...
		try {
			URL baseUrl;
			baseUrl = org.openkoala.koala.jbpm.wsclient.JBPMApplicationImplService.class
					.getResource(".");
