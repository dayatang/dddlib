...
+function( $ ) {
  ...
  DateTimePicker.prototype = {
    ...
    init: function(element, options) {
	  ...
	  this.timeIcon = 'glyphicon-time';
	  this.dateIcon = 'glyphicon-calendar';
      if (this.pickTime) {
           icon.addClass(this.timeIcon);
      }
      if (this.pickDate) {
	      icon.addClass(this.dateIcon).removeClass(this.timeIcon)
      }
    ...
    getDate: function() {
      ...
      return new Date(this._date.valueOf() + this._date.getTimezoneOffset() * 60 * 1000);
    },
        ...
        '<div class="datetimepicker">' +
          '<ul>' +
            '<li' + (collapse ? ' index="1" class="collapse in"' : '') + '>' +
              ...
              '</div>' +
            '</li>' +
            '<li  index="2" class="picker-switch accordion-toggle"><a><i class="glyphicon ' + timeIcon + '"></i></a></li>' +
