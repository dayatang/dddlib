	...
	$("#maingrid").ligerGrid(
		{
			...
			dataAction : 'server',
			rownumbers : true,
			url : '${pageContext.request.contextPath}/monitor/Monitor/jdbcMonitorDetail.koala?timestamp='+new Date().getTime()+'&unit='+$("#unit").val()+'&requestDate=' + $("#requestDate").val() + '&system=' + $("#system").val(),
