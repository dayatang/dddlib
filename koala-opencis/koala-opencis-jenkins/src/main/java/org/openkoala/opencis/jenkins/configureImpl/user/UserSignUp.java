 ...
 * Time: 2:48 PM
 */
public class UserSignUp extends UserCreator {


    public UserSignUp(String jenkinsUrl) {
        super(jenkinsUrl);
    }

    public static UserSignUp create(String jenkinsUrl) {
        return new UserSignUp(jenkinsUrl);
    }
