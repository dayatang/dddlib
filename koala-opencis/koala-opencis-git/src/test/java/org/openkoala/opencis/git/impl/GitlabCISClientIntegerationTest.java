...
public class GitlabCISClientIntegerationTest {
    ...
    private GitlabConfiguration getConfigurationForTest() {
        ...
        result.setAdminUsername("root");
        result.setAdminPassword("root");
    ...
    public void testAuthentication() {
        ...
        CISClient cisClient = new GitlabCISClient();
        cisClient.authenticate();


        // GitlabHTTPRequestor gitlabHTTPRequestor =  new GitlabHTTPRequestor();
