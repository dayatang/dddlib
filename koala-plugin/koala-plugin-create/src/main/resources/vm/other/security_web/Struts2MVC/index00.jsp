...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/auth/changepassword_spring.js"></script>
...
function loadLeftMenu() {
	 ...
	 //加载栏目
     $.getJSON('${pageContext.request.contextPath}/auth-Menu-findTopMenuByUser.action', function (menus)
     {
