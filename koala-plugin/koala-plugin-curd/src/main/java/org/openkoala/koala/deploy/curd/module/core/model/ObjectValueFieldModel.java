...
/**
 * 类    名：ObjectValueFieldModel.java
 *   
 * 功能描述：值对象FieldModel
 *  
 * 创建日期：2013-1-23上午11:31:24     
 * 
 * 版本信息：
 * 
 ...
 */
public class ObjectValueFieldModel extends FieldModel {

    /**
     * 
     */
    public ObjectValueFieldModel() {
        super();
     ...
     * @param type
     */
    public ObjectValueFieldModel(String name, String type) {
        super(name, type);
        // TODO Auto-generated constructor stub
    }
