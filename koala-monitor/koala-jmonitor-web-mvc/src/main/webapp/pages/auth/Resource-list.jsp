...
<body style="padding:10px;height:100%; text-align:center;">
  ...
  $(function() {
		...
		$.getJSON("/auth/Resource/findAllResourceType.koala", function(result) {
		...
		var grid = $("#maingrid").ligerGrid({
			...
			url : '/auth/Resource/findAllReourceTree.koala',
			sortName : 'id',
			width : '98%',
			height : '100%',
			rowHeight: 28,//行默认的高度
		...
		function saveUrlResource() {
			...
			if (isEdit) {
				url = "/auth/Resource/update.koala";
				data = [ {
					name : "resourceVO.id",
				...
				if (!selectedRow) {
					...
					url = "/auth/Resource/addAndAssignParent.koala";
					data = {
