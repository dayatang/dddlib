	...
	*/
	function showStack(id){
		$.layer({
		    ...
		    iframe : {src : '${pageContext.request.contextPath}/monitor/Monitor/stackTracesDetail.koala?monitorType=jdbc&detailsId='+id},
		    area : ['900px' , '400px'],
		    offset : ['50%' , '']
		});
	}
	...
	*/
	function showSqls(id){
		...
		$.layer({
		    ...
		    iframe : {src : '${pageContext.request.contextPath}/monitor/Monitor/sqlsMonitorDetail.koala?jdbcDetailsId='+id},
		    area : ['900px' , '400px'],
		    offset : ['50%' , '']
		});
	}
...
<body>
	...
	<div id="maingrid"></div>
	<script src="${pageContext.request.contextPath}/js/monitor/jdbcMonitorDetail.js" type="text/javascript"></script>
</body>
