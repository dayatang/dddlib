...
import org.dayatang.jpa.internal.JpaCriteriaQueryBuilder;
...
public class EntityRepositoryJpa implements EntityRepository {
    ...
    @Override
    public <T extends Entity> org.dayatang.domain.Query<T> createQuery(Class<T> entityClass) {
        return new QueryImpl(this, entityClass);
    }

    @Override
    public <T extends Entity> List<T> find(org.dayatang.domain.Query<T> dddQuery) {
        return find(dddQuery, dddQuery.getEntityClass());
    }

    @Override
    public <T extends Entity> T getSingleResult(org.dayatang.domain.Query<T> dddQuery) {
        return getSingleResult(dddQuery, dddQuery.getEntityClass());
    }

    @Override
    public <E, T extends Entity> List<E> find(org.dayatang.domain.Query<T> dddQuery, Class<E> resultClass) {
        CriteriaQuery<T> criteriaQuery = JpaCriteriaQueryBuilder.getInstance()
    ...
    @Override
    public <E, T extends Entity> E getSingleResult(org.dayatang.domain.Query<T> query, Class<E> resultClass) {
